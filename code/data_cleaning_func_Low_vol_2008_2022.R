...
data_cleaning_func_Low_vol_2008_2022 <- function(df_data){
...
hi_vol_data <- combined_data_ALSI_REIT %>% filter(YearMonth %in% Low_Vol) %>% # filter for months of high volatility
