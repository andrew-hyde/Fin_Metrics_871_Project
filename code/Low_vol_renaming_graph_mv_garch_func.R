...
Low_vol_graph_rename_func_mv <- function(input_name_1, input_name_2, title, subtitle, caption, xlabel, ylabel) {
    ...
    Rhot_use <-
        renamingdcc(ReturnSeries = xts_Low_Vol_ALSI_data_combined_,
                    DCC.TV.Cor = DCC_$rho.t)
