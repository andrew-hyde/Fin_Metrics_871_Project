...
#    EXTRA CODE: USE IN THE 'COMBINED NESTED FUNC'
...
# save the combined data as a backup
saveRDS(combined_data_ALSI_REIT, file = "data/combined_alsi_data.rds")
...
xts_q6_data_combined_use <- data_cleaning_func(df_data)



DCCPre <- dccPre(xts_q6_data_combined_use, include.mean = F, p = 0)
